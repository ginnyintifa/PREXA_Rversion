...
#cancer_muse=fread("BRCA_muse.maf", stringsAsFactors = F)
#cancer_mutect=fread("BRCA_mutect.maf", stringsAsFactors = F)
#cancer_somatic=fread("BRCA_somatic.maf", stringsAsFactors = F)
#cancer_varscan=fread("BRCA_varscan.maf", stringsAsFactors = F)

#brca_cancer = get_tcga_whole(cancer_muse, cancer_mutect, cancer_somatic, cancer_varscan, "BRCA")
